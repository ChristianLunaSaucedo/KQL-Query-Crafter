...
- Output ONLY the final raw KQL query string, followed immediately by your source citations.
...
- CITE YOUR SOURCES AFTER YOU ANSWER!
...
while True:
    user_input = input("Please Enter Your Scenario: ")
    response = rag_system.AskQuestion(chain, user_input)
    print(response)
