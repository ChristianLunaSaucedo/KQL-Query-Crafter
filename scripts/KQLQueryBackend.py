...
class KQLQueryHandler:
    ...
    def CreateChain(self):
        ...
        Double check to ensure you did not make this field up (ALWAYS cite sources of a field (I need the snippet of it in the "ecs.masterfieldslist.enriched.md" file). You are allowed to use the actual field and tell the user to find the specific value themselves, but this is non negotiable)
